/*
    ? Problem: Q2(II) of assignment 12.
    ...
    ! Approach: Quadratic Probing Method.(Duplicate values can be present but we can remove them by providing another check)
*/
...
class HashTable {
    ...
    // * This function returns the quadratically probed index by the formula (hashFunc(v) + (c * no. of collisions) + (c * no. of collisions)^2) % max_size
