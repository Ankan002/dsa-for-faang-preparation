...
class HashTable {
    ...
    // * This function is responsible for deleting the number from the array on the given index generated by hash function.
    deleteNum(key: string): void {
        let index = this.hashFunction(key);
        
        delete this.numArray[index];
    }
}
...
hashTable.deleteNum("March 2023");
console.log(hashTable.getNum("March 2023"));
